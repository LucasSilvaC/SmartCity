...
export default function Panel({ label, count }) {
  ...
  return (
    <article
      className="relative w-full h-64 rounded-lg overflow-hidden shadow-md bg-gradient-to-tr from-gray-900 via-gray-800 to-gray-900 border border-gray-700"
      aria-label={`Informações sobre ${label}`}
    >
      <FaTree
        className="absolute text-white/80 text-[18rem] bottom-[-2rem] right-[-1rem] z-0"
        aria-hidden="true"
      />
